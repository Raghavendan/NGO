                ...
                <div className="about-info-section">
                    ...
                    <div className="info-mission">
                        ...
                        <div className="mission-content">
                            <img src={mis} alt="Mission Image" className="info-img" />
                    ...
                    <div className="info-vision">
                        ...
                        <div className="vision-content">
                            <img src={vis} alt="Vision Image" className="info-img" />
                    ...
                    <div className="info-contact">
                        ...
                        <p className="add">🌏 Address: No. 2A, Second Floor, Vedammal Ave, Dr.Subbaraya Nagar, Kodambakkam, Chennai, Tamil Nadu 600024 <a href="https://maps.google.com/?q=No.+2A,+Second+Floor,+Vedammal+Ave,+Dr.Subbaraya+Nagar,+Kodambakkam,+Chennai,+Tamil+Nadu+600024" target="_blank">Location here</a></p>
